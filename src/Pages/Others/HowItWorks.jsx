    ...
    <div className="min-h-screen bg-linear-to-b from-zinc-950 to-zinc-900">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[radial-linear(circle_at_30%_20%,rgba(16,185,129,0.15),transparent_50%)]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6">
              How <span className="bg-linear-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">CommunityFix</span> Works
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="group px-8 py-4 bg-linear-to-r from-emerald-500 to-teal-500 rounded-2xl font-bold text-lg text-white shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
              The <span className="bg-linear-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Four-Step</span> Process
            </h2>
          ...
          {/* Active Step Detail */}
          <div className="bg-linear-to-br from-zinc-800 to-zinc-900 rounded-3xl border border-zinc-700 overflow-hidden mb-16">
            <div className="grid lg:grid-cols-2">
              {/* Left Side - Step Details */}
              <div className="p-12">
                <div className="flex items-center space-x-4 mb-6">
                  <div className={`bg-linear-to-r ${steps[activeStep].color} w-20 h-20 rounded-2xl flex items-center justify-center text-white`}>
              ...
              {/* Right Side - Visual */}
              <div className="relative bg-linear-to-br from-zinc-900 to-black p-12 flex items-center justify-center">
                <div className="relative w-full max-w-md">
                  {/* Step-specific visualization */}
                  {activeStep === 0 && (
                    <div className="space-y-6">
                      <div className="bg-linear-to-r from-blue-500/20 to-cyan-500/20 rounded-2xl p-6 border border-blue-500/30">
                  ...
                  {activeStep === 1 && (
                    <div className="space-y-6">
                      <div className="bg-linear-to-r from-emerald-500/20 to-teal-500/20 rounded-2xl p-6 border border-emerald-500/30">
                        <div className="flex items-center space-x-4 mb-4">
                  ...
                  {activeStep === 2 && (
                    <div className="space-y-6">
                      <div className="bg-linear-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-6 border border-purple-500/30">
                        <div className="flex items-center space-x-4 mb-4">
                  ...
                  {activeStep === 3 && (
                    <div className="space-y-6">
                      <div className="bg-linear-to-r from-amber-500/20 to-orange-500/20 rounded-2xl p-6 border border-amber-500/30">
                        <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
                              <div className="h-full bg-linear-to-r from-amber-500 to-orange-500" style={{ width: '85%' }} />
                            </div>
                          </div>
                          <div className="text-center">
              ...
              <div key={step.number} className="text-center">
                <button
                  ...
                  className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-3 transition-all duration-300 ${
                    activeStep === index
                      ? `bg-linear-to-r ${step.color} text-white transform scale-110 shadow-xl`
      ...
      <section className="py-20 px-6 bg-linear-to-b from-zinc-900 to-zinc-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
              Why It <span className="bg-linear-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Works</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group bg-linear-to-br from-zinc-800 to-zinc-900 rounded-3xl p-8 border border-zinc-700 hover:border-emerald-500/50 transition-all duration-500">
                <div className={`w-16 h-16 bg-linear-to-r ${feature.color} rounded-2xl flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform duration-500`}>
                  {feature.icon}
                </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
              Community <span className="bg-linear-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Success</span> Stories
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-linear-to-br from-zinc-800 to-zinc-900 rounded-3xl border border-zinc-700 p-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-linear-to-br from-zinc-800 to-zinc-900 rounded-3xl p-12 border border-zinc-700 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <NavLink
                to="/report"
                className="group px-10 py-5 bg-linear-to-r from-emerald-500 to-teal-500 rounded-2xl font-bold text-lg text-white shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3"
              >
      ...
      {videoPlaying && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
          ...
          <div className="relative bg-linear-to-br from-zinc-900 to-zinc-800 rounded-3xl border border-zinc-700 max-w-4xl w-full p-8 shadow-2xl">
            <button
              onClick={() => setVideoPlaying(false)}
            ...
            <div className="aspect-video bg-black rounded-2xl overflow-hidden mb-6">
              <div className="w-full h-full flex items-center justify-center bg-linear-to-br from-emerald-900/30 to-teal-900/30">
                <div className="text-center">
