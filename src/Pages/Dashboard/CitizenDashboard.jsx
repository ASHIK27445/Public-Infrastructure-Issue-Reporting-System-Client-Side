...
const CitizenDashboard = () => {
  ...
  const issuesOverTime = [
    ...
    { month: 'Feb', reported: 18, resolved: 12 },
    { month: 'Mar', reported: 15, resolved: 10 },
    { month: 'Apr', reported: 22, resolved: 18 },
    { month: 'May', reported: 19, resolved: 15 },
    { month: 'Jun', reported: 25, resolved: 22 }
  ];

  const categoryDistribution = [
    { name: 'Road & Traffic', value: 35, color: '#10b981' },
  ...
  const priorityDistribution = [
    { priority: 'Critical', issues: 3, color: '#ef4444' },
    { priority: 'High', issues: 8, color: '#f97316' },
    { priority: 'Normal', issues: 24, color: '#10b981' },
    { priority: 'Low', issues: 5, color: '#3b82f6' }
  ];

  const resolutionTimeData = [
    { category: 'Road Issues', avgTime: 3.2 },
    { category: 'Water Issues', avgTime: 2.8 },
    { category: 'Power Issues', avgTime: 4.1 },
    { category: 'Sanitation', avgTime: 1.5 },
    { category: 'Safety', avgTime: 5.2 }
  ];
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-4xl font-black text-white mb-2">
                Citizen <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">Dashboard</span>
              </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
          {statCards.map((stat, index) => (
            <div 
              key={index} 
              className="group relative bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-3xl border border-zinc-700 p-6 hover:border-emerald-500/50 transition-all duration-500"
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-2xl ${stat.gradient} ${stat.color} text-white`}>
                  {stat.icon}
                </div>
        ...
        {/* Recent Issues Table */}
        <div className="bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-3xl border border-zinc-700 overflow-hidden mb-8">
              ...
              <tbody>
                {recentIssues.map((issue) => (
                  <tr key={issue.id} className="border-b border-zinc-700 hover:bg-zinc-800/50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <div className={`inline-flex items-center space-x-2 px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r ${getStatusColor(issue.status)} text-white`}>
          ...
          <div className="p-6 border-t border-zinc-700">
            <div className="flex items-center justify-between">
              ...
              <NavLink
                to="/report"
                className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl text-white font-bold hover:shadow-emerald-500/50 transition-all"
              >
